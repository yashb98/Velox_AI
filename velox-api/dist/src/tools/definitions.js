...
exports.tools = [
    ...
    // ── 4.5 — New tools ───────────────────────────────────────────────────────
    {
        ...
        description: "Book an appointment for a customer at a specified date and time. " +
        ...
        parameters: {
            ...
            properties: {
                ...
                service_type: {
                    type: "string",
                    description: "Type of service or appointment (e.g., 'consultation', 'delivery', 'support')",
                },
            },
    ...
    {
        name: "search_faq",
        description: "Search the company FAQ knowledge base for an answer to a customer's question. " +
    ...
    },
    {
        ...
        description: "Retrieve a customer's profile information including their name, account status, " +
        ...
        parameters: {
            ...
            properties: {
                ...
                phone_number: {
                    type: "string",
                    description: "The customer's phone number as an alternative lookup (e.g., +14155552671)",
                },
            },
    ...
    },
    {
        ...
        description: "Escalate the current call to a live human agent when the AI cannot resolve the " +
        ...
        parameters: {
            ...
            properties: {
                reason: {
                    type: "string",
                    description: "Brief reason for escalation (e.g., 'billing dispute', 'customer request', " +
                        "'complex technical issue')",
                },
                priority: {
                    type: "string",
                    enum: ["normal", "urgent"],
                    description: "'urgent' for angry/distressed customers or safety issues, 'normal' otherwise",
                },
            },
            required: ["reason"],
        },
